...
class FurnitureTypedDict(TypedDict):
    ...
    on_break_spill_items: NotRequired[List[Dict[str, Any]]]  # List of FurnitureOnBreakSpillItem
    use_item_interaction: NotRequired[List[Dict[str, Any]]]  # List of FurnitureUseInteractionRuleTypedDict
...
class RoomTypedDict(TypedDict):
    ...
    furniture: NotRequired[List[Union[str, Dict[str, Any]]]]  # str or FurnitureTypedDict
    objects: NotRequired[List[Union[str, Dict[str, Any]]]]  # str or RoomObjectTypedDict
    ...
    npcs: NotRequired[List[Dict[str, Any]]]  # List of NPCTypedDict
    npcs_present: NotRequired[List[Dict[str, Any]]]  # List of NPCTypedDict
...
class HazardStateTypedDict(TypedDict, total=False):
    ...
    environmental_omens: Dict[str, Dict[str, str]]

class HazardTypedDict(TypedDict, total=False):
    name: str
    initial_state: str
    states: Dict[str, Any]  # Dict of state_name -> HazardStateTypedDict (validated as Any to avoid isinstance issues)
    sabotage: Dict[str, Any]
    object_name_options: List[str]
    player_interaction: Dict[str, Any]  # Dict of action -> List[PlayerInteractionRuleTypedDict] (validated as Any)
    triggered_by_room_action: List[Dict[str, Any]]
...
class NPCTypedDict(TypedDict):
    ...
    description: str
    initial_state: str
    dialogue_states: Dict[str, Any]  # Dict of state_name -> DialogueStateTypedDict
...
class PlayerAchievementsFileTypedDict(TypedDict):
    achievements: Dict[str, Any]  # Dict of achievement_id -> AchievementTypedDict
